...
let rl = readline.createInterface(process.stdin, process.stdout); // set up stdin and stdout

// set up an array of options we will present the user in a menu
let menuOptions = [
    // each option is an object containing an id number, a title, a file to be imported if the option is selected, and a confirmation message for when the user picks it
    {
        "id": 1,
...
/**
 * This function generates a menu of options to present to the user, based on the menuOptions array defined globally above
 */
function getMenu() {
